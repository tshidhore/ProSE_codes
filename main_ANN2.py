...
# Function to generate the required input, output lists needed for the ANN model
...
def generate_io_arr(files_i,files_o,labels,search_word="None"):
    ...
    # Define the input and output arrays for ANN
    input_arr = []
    output_arr = []
...
# Function to check the sensitivity of the ANN model to various material parameters
...
def Test_ANN(ti_folder,to_folder,search_word,labels=False):
    #**********************************************************************#
...
def Sample_ANN(ti_folder,to_folder,vi_folder,vo_folder):
    ...
    print ("The accuracy of the ANN prediction is %f" %(p_accuracy))
    return p_accuracy                                             
...
p1 = Test_ANN(ti_folder,to_folder,"e1")
p2 = Test_ANN(ti_folder,to_folder,"gc1")
p3 = Test_ANN(ti_folder,to_folder,"d1")
p4 = Test_ANN(ti_folder,to_folder,"e3")
p5 = Test_ANN(ti_folder,to_folder,"gc3")
p6 = Test_ANN(ti_folder,to_folder,"d3")

# Test for missing interpolated values
p7 = Test_ANN(ti_folder,to_folder,"e2")
p8 = Test_ANN(ti_folder,to_folder,"gc2")
p9 = Test_ANN(ti_folder,to_folder,"d2")

# Raw material properties linearly scaled down to 0,1
p1l = Test_ANN(ti_folder,to_folder,"e1",True)
p2l = Test_ANN(ti_folder,to_folder,"gc1",True)
p3l = Test_ANN(ti_folder,to_folder,"d1",True)
p4l = Test_ANN(ti_folder,to_folder,"e3",True)
p5l = Test_ANN(ti_folder,to_folder,"gc3",True)
p6l = Test_ANN(ti_folder,to_folder,"d3",True)

# Test for missing interpolated values
p7l = Test_ANN(ti_folder,to_folder,"e2",True)
p8l = Test_ANN(ti_folder,to_folder,"gc2",True)
